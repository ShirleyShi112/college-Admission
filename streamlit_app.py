...
# Load the dataset
df = pd.read_csv("https://huggingface.co/spaces/NYU-DS-4-Everyone/admission/resolve/main/src/Admission_Predict_Ver1.1.csv")

# Set the page configuration for our Streamlit app
st.set_page_config(
    page_title="Graduate University Admission ",
    layout="centered",
    page_icon="https://huggingface.co/spaces/NYU-DS-4-Everyone/admission/resolve/main/src/graduation.png", 
)
...
# Display the selected page content based on the user's choice":
    ...
    with st.spinner('Loading page...'):
        ...
        if selected_tab == tab_labels[0]:
            ...
            try:
                ready_df = pd.read_csv("https://huggingface.co/spaces/NYU-DS-4-Everyone/admission/resolve/main/src/Pycaret_comparison.csv")
            ...
            os.environ["DAGSHUB_CONFIG_DIR"] = "/tmp/.config"
